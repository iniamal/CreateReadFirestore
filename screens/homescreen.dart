...
import 'package:newcrud/screens/note_editor.dart';
import 'package:newcrud/screens/note_reader.dart';
import 'package:newcrud/styles/app_style.dart';
import 'package:newcrud/widgets/note_card.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Expanded(child: StreamBuilder<QuerySnapshot>(stream: FirebaseFirestore.instance.collection("notes").snapshots(),
       builder: (context, AsyncSnapshot<QuerySnapshot> snapshot){
         ...
         return Text("theres no datas", style: GoogleFonts.nunito(color: Colors.white),);},
      ),)
      ])
      ),
